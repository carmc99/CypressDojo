        ...
        <div className="App flex min-h-screen w-full justify-center items-center bg-gray-100">
          ...
          <div className="card md:w-96 min-h-12 p-4 bg-base-100 shadow-xl">
            ...
            >
                ...
                <button type="submit" className="btn btn-circle btn-ghost text-gray-400">
            ...
            <div className="flex flex-col gap-2">
              {tasks.map((task) => (
                  <div
                      key={task.id}
                      className="flex gap-2 p-2 bg-gray-100 rounded-xl w-full justify-between items-center"
                  >
